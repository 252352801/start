...
export const laydate = function() {
    ...
    var e = window.layui && layui.define,
        ...
        n = {
            ...
            ready: function(a) {
                ...
                return e ? layui.addcss(o, a, i) : t.link('', a, i), this
            }
        },
    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function() {
        ...
        return t[0]
    }, w.ie = function() { var e = navigator.userAgent.toLowerCase(); return !!(window.ActiveXObject || "ActiveXObject" in window) && ((e.match(/msie\s(\d+)/) || [])[1] || "11") }(), w.stope = function(e) { e = e || win.event, e.stopPropagation ? e.stopPropagation() : e.cancelBubble = !0 }, w.each = function(e, t) {
        var n, a = this;
        ...
        return n[0] && !n.hasClass(c) && t.checkDate(function() { n.remove() }), t
