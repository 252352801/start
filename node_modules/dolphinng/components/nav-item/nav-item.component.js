...
var NavItemComponent = (function () {
    ...
    NavItemComponent.prototype.ngOnInit = function () {
        ...
        this.rootElem.addEventListener('click', function (ev) {
            ...
            var subNavWraps = document.querySelectorAll('nav-item .nav-sub');
            if (subNavWraps) {
                for (var i = 0, len = subNavWraps.length; i < len; i++) {
            ...
            var subWrap = _this.rootElem.querySelector('.nav-sub');
            if (wouldActive) {
                _this.addClass(_this.rootElem, 'active');
                if (subWrap) {
                    setTimeout(function () {
                        var children = subWrap.querySelectorAll('li');
                        var height = 0;
                        if (children) {
                        ...
                        subWrap.style.height = height + 'px';
                    });
                }
            }
            else {
                if (subWrap) {
                    subWrap.style.height = '0';
                }
            }
        });
